...
execute positioned ~-0.5 ~-0.5 ~-0.5 as @n[dx=0,dy=0,dz=0,tag=!immune] run damage @s 7 arrow by @s from @p[tag=immune]
...
execute if score @s raycast.steps matches 1.. if score @s raycast.hit matches 0 positioned ^ ^ ^0.1 run function code:weapons/ak47/raycast